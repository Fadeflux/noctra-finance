...
console.log('\n-- on peut en sortir volontairement --');
{
  ...
  const r = jouer('?ro=0', { ccn_ro: '1' });
  V('`?ro=0` rend lՎcriture', r.lectureSeule === false);
  V('... et oublie le mode pour la suite', r.sac.ccn_ro === undefined, JSON.stringify(r.sac));
}
